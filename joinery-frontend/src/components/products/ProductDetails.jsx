...
const productableAttributes = {
  ...
  Moulding: [
    ...
    { name: 'substrate_material', label: 'Substrate Material' },
    { name: 'length_per_piece_feet', label: 'Length per Piece (feet)' },
    { name: 'nominal_width_inches', label: 'Nominal Width (inches)' },
    { name: 'nominal_thickness_inches', label: 'Nominal Thickness (inches)' },
    { name: 'actual_width_inches', label: 'Actual Width (inches)' },
    { name: 'actual_thickness_inches', label: 'Actual Thickness (inches)' },
    { name: 'profile_type', label: 'Profile Type' },
    { name: 'profile_style', label: 'Profile Style' },
    { name: 'standard_id', label: 'Standard ID' },
    { name: 'surfacing', label: 'Surfacing' },
    { name: 'finish_sanded', label: 'Finish Sanded' },
    { name: 'edge_treatment', label: 'Edge Treatment' },
  ],
  SheetGood: [
  ...
  Veneer: [
    { name: 'species', label: 'Species' },
    { name: 'veneer_type', label: 'Veneer Type' },
    { name: 'cut_style', label: 'Cut Style' },
    { name: 'thickness_value', label: 'Thickness' },
    { name: 'thickness_unit', label: 'Thickness Unit' },
    { name: 'length_in_inches', label: 'Length (inches)' },
    { name: 'width_in_inches', label: 'Width (inches)' },
    { name: 'match_type', label: 'Match Type' },
    { name: 'leaf_count', label: 'Leaf Count' },
    { name: 'sequenced', label: 'Sequenced' },
    { name: 'flitch_identifier', label: 'Flitch Identifier' },
